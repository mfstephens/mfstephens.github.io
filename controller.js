...
$("#projects").click(function() {
	$(".content").html('<div class="project-preview first"> <p> </p> </div> <div class="project-preview last"></div> <div class="project-preview first"></div> <div class="project-preview last">');
});
